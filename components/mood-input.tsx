  ...
  return (
    <div className="space-y-5 bg-white/40 dark:bg-[#1F2E36] backdrop-blur-md rounded-2xl p-8 border border-white/20 dark:border-white/10 shadow-sm dark:shadow-black/30">
      <div className="space-y-2">
        <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#2F3E46]/60 dark:text-[#C8B8A0]">
        ...
        <textarea
          ...
          rows={6}
          className="w-full rounded-xl bg-white/60 dark:bg-[#263540] border border-white/40 dark:border-white/20 px-4 py-3 text-sm text-[#2F3E46] dark:text-[#EAE0D0] placeholder:text-[#2F3E46]/30 dark:placeholder:text-[#A89880] focus:outline-none focus:ring-2 focus:ring-[#2F3E46]/20 dark:focus:ring-[#C4785C]/40 resize-none transition-all"
        />
        <p className="text-[10px] text-[#2F3E46]/40 dark:text-[#A89880] leading-relaxed">
