        ...
        <article className="relative z-10 max-w-2xl mx-auto px-6 pt-20 pb-32">
          ...
          <div className="space-y-8 font-sans text-base md:text-lg leading-relaxed text-[#2F3E46]/90">
            ...
            <section className="space-y-6 pt-4">
              ...
              <p>
                Loneliness is not a character flaw. John Cacioppo's four-decade study found
                the brain processes social isolation in the same regions it registers physical
                pain. It is your system's biological thirst alarm. And the consequences
                compound: chronic loneliness increases mortality risk as severely as smoking
                15 cigarettes a day.
              </p>
              <p>
                The longest-running scientific study on human happiness, Harvard's 83-year
                Study of Adult Development, found that not wealth, fame, or even exercise
                was the primary driver of a long life. It was{" "}
                <strong>relationship quality</strong>.
              </p>
              <p>
                We are not broken. We are malnourished.
              </p>
            </section>
